...
import { type IRepository, type ISearchableRepository } from '../../../domain/repository/repository-interface'
import { type SearchParams, type SortDirection } from '../../../domain/repository/search-params'
...
> extends InMemoryRepository<E, EntityID>
  ...
  protected applySort (
    ...
    return [...items].sort((a, b) => {
      const valueA = (customGetter != null) ? customGetter(sort, a) : (a as any)[sort]
      const valueB = (customGetter != null) ? customGetter(sort, b) : (b as any)[sort]
