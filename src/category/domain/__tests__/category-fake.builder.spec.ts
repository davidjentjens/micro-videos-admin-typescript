  ...
  describe('categoryId prop', () => {
    ...
    test('should throw error when any with methods has called', () => {
      expect(() => faker.categoryId).toThrow(
        new Error(
          "Property categoryId does not have a factory, use 'with' methods"
        )
      )
    })
    ...
    test('should call the categoryId factory method when it is passed', () => {
  ...
  describe('createdAt prop', () => {
    ...
    test('should throw error when any with methods has called', () => {
      ...
      expect(() => fakerCategory.createdAt).toThrow(
        new Error("Property createdAt does not have a factory, use 'with' methods")
      )
    })
    test('should be undefined', () => {
